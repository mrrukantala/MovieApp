...
class DetailMovieFragment : Fragment() {
    ...
    private fun fetchReviewMovieOnEmpty() {
        binding.msvReview.viewState = MultiStateView.ViewState.EMPTY
    }
    ...
    private fun fetchVideoMovieOnLoading() {
        binding.msvVideo.viewState = MultiStateView.ViewState.LOADING
    }
    ...
    private fun fetchVideoMovieOnSuccess(data: List<VideoEntity>) {
        if (data.isNotEmpty()) {
            ...
            fetchVideoMovieOnEmpty()
        }

    }

    private fun fetchVideoMovieOnEmpty() {
        binding.msvVideo.viewState = MultiStateView.ViewState.EMPTY
    }
